...
[@steambrew/docs](../../../modules.md) / [client/src](../README.md) / MsgClientSettings
...
### always\_use\_gamepadui\_overlay()
...
### broadcast\_show\_live\_reminder()
...
### broadcast\_show\_upload\_stats()
...
### cef\_remote\_debugging\_enabled()
...
### controller\_combine\_nintendo\_joycons()
...
### controller\_guide\_button\_focus\_steam()
...
### controller\_power\_off\_timeout()
...
### download\_throttle\_while\_streaming()
...
### enable\_gpu\_accelerated\_webviews()
...
### enable\_hardware\_video\_decoding()
...
### enable\_screenshot\_notification()
...
### enable\_shader\_background\_processing()
...
### force\_fake\_mandatory\_update()
...
### g\_background\_time\_resolution()
...
### game\_notes\_enable\_spellcheck()
...
### gamerecording\_automatic\_gain\_control()
...
### gamerecording\_export\_directory()
...
### gamerecording\_export\_limit\_bitrate()
...
### gamerecording\_export\_limit\_frame\_rate()
...
### gamerecording\_export\_limit\_height()
...
### gamerecording\_export\_limit\_size\_mb()
...
### gamerecording\_export\_limit\_type()
...
### gamerecording\_export\_limit\_width()
...
### gamerecording\_force\_mic\_mono()
...
### gamerecording\_video\_maxheight()
...
### gamescope\_app\_target\_framerate()
...
### gamescope\_disable\_framelimit()
...
### gamescope\_disable\_mura\_correction()
...
### gamescope\_display\_refresh\_rate()
...
### gamescope\_enable\_app\_target\_framerate()
...
### gamescope\_include\_steamui\_in\_screenshots()
...
### gamescope\_use\_game\_refresh\_rate\_in\_steam()
...
### gamestream\_enable\_video\_h265()
...
### gamestream\_hardware\_video\_encode()
...
### library\_disable\_community\_content()
...
### library\_display\_icon\_in\_game\_list()
...
### library\_whats\_new\_show\_only\_product\_updates()
...
### music\_download\_high\_quality()
...
### overlay\_fps\_counter\_high\_contrast()
...
### overlay\_restore\_browser\_tabs()
...
### override\_browser\_composer\_mode()
...
### ready\_to\_play\_includes\_streaming()
...
### restrict\_auto\_updates\_start()
...
### save\_uncompressed\_screenshots()
...
### show\_copy\_count\_in\_library()
...
### show\_family\_sharing\_notifications()
...
### show\_store\_content\_on\_home()
...
### skip\_steamvr\_install\_dialog()
...
### startup\_movie\_used\_for\_resume()
...
### steam\_cef\_gpu\_blocklist\_disabled()
...
### steam\_input\_configurator\_error\_msg\_enable()
...
### steamos\_cec\_wake\_on\_resume()
...
### steamos\_status\_led\_brightness()
...
### steamos\_wifi\_force\_wpa\_supplicant()
...
### turn\_off\_controller\_on\_exit()
...
### voice\_push\_to\_talk\_setting()
