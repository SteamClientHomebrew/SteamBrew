...
[@steambrew/docs](../../../modules.md) / [client/src](../README.md) / DialogButtonProps

# Interface: DialogButtonProps

Defined in: [packages/client/src/components/Dialog.ts:8](https://github.com/SteamClientHomebrew/Millennium/blob/8a57b02d3469279aae948570883c198c8e14d879/src/sdk/packages/client/src/components/Dialog.ts#L8)

## Extends

- [`FooterLegendProps`](FooterLegendProps.md).`ButtonHTMLAttributes`\<`HTMLButtonElement`\>
...
`ButtonHTMLAttributes.onResizeCapture`
