    ...
    useEffect(() => {
        const onGlobalContextMenu = (e) => {
            if (e.detail && e.detail.instanceId !== instanceId) {
                setContextMenu((ctx) =>
                    ctx.visible ? { ...ctx, visible: false } : ctx,
                );
            }
        };
            ...
            >
                ...
                >
                    <img
                        ...
                        src="https://i.imgur.com/2aAaAES.gif"
                        data-holder-rendered="true"
                    />
                    <div className="card-body">
                        <h3 className="card-title">Fluenty</h3>
                        <p className="card-description package-description">
                            {fluenty.description}
                        </p>
                            ...
                            <div className="card-stats">
                                <div className="card-stat" id="addon-likes">
                                    <div className="pfp-name">
                                        <p className="card-subtext package-author">
                                            by Steam Homebrew
                                        </p>
                    ...
                    <div className="downloadTag">
                        ...
                        <span className="downloadTagText">
                            {fluenty.downloads}
                        </span>
                    </div>
                </div>
