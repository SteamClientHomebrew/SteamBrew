...
.landscape .landscapeItem.mountains.midground {
	z-index: 2;
	background-image: url(https://raw.githubusercontent.com/SteamClientHomebrew/SteamBrew/refs/heads/main/steambrew/static/mountain4.svg);
}
.landscape .landscapeItem.mountains.foreground {
	z-index: 3;
	background-image: url(https://raw.githubusercontent.com/SteamClientHomebrew/SteamBrew/refs/heads/main/steambrew/static/mountain3.svg);
}
...
.landscape .landscapeItem.trees.background {
	z-index: 4;
	background-image: url(https://raw.githubusercontent.com/SteamClientHomebrew/SteamBrew/refs/heads/main/steambrew/static/mountain2.svg);
}
.landscape .landscapeItem.trees.midground {
	z-index: 5;
	background-image: url(https://raw.githubusercontent.com/SteamClientHomebrew/SteamBrew/refs/heads/main/steambrew/static/mountain1.svg);
}
.landscape .landscapeItem.trees.foreground {
	z-index: 6;
	background-image: url(https://raw.githubusercontent.com/SteamClientHomebrew/SteamBrew/refs/heads/main/steambrew/static/mountain.svg);
}
