...
That's the `http` module — a compact, consistent HTTP client API for Millennium Lua plugins. If you want, I can split the inline examples into real example files under `steambrew/docs/src/plugins/lua/examples/` and update the code-fence paths accordingly.
